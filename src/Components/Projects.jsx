...
export default function Projects({ scrollRef, setActive, view, viewRef }) {
  ...
  return (
    <div id="Projects" ref={setRefs} className="flex flex-col items-center mb-[30px]">
      <div className="flex justify-center font-bold text-[48px] tracking-[0.315em] pt-[120px] ">PROJECTS</div>
